...
const reviews = [
  {
    quote: "The craftsmanship is extraordinary. Each piece feels like it carries the warmth of the hands that made it.",
    name: "Priya Sharma",
    city: "Mumbai",
    rating: 5,
  },
  {
    quote: "I've never owned ceramics that feel so alive. The terracotta diffuser has become the soul of my living room.",
    name: "Arjun Mehta",
    city: "Bangalore",
    rating: 5,
  },
  {
    quote: "Finally, a brand that celebrates Indian craft without compromising on contemporary aesthetics. Absolutely stunning.",
    name: "Ananya Reddy",
    city: "Hyderabad",
    rating: 5,
  },
  {
    quote: "Every piece tells a story. The attention to detail and the quality of craftsmanship is unmatched.",
    name: "Vikram Singh",
    city: "Delhi",
    rating: 5,
  },
